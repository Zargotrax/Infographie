...
void Operation::apply() {
	for (Object* obj : targets) {
		...
		obj->scaleX = obj->scaleZ * transformation->scaleX;
		obj->scaleY = obj->scaleZ * transformation->scaleY;
...
void Operation::rollback() {
	for (Object* obj : targets) {
		...
		obj->scaleX = obj->scaleZ * (1 / transformation->scaleX);
		obj->scaleY = obj->scaleZ * (1 / transformation->scaleY);
